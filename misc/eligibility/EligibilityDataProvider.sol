...
contract EligibilityDataProvider is OwnableUpgradeable {
	...
	/**
	 * @notice Returns locked Met and LP token value in eth
	...
	/**
	 * @notice Returns locked Met and LP token value in USD
